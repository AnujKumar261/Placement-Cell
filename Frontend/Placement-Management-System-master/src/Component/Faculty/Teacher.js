    ...
    <div className={TeacherCSS.home}>
      <div className={TeacherCSS.std}>
        ...
        <div className={TeacherCSS.wrapper}>
          ...
          <div className={TeacherCSS.card}>
            <img src="https://banner2.cleanpng.com/20180330/icq/kisspng-sql-server-reporting-services-computer-icons-chart-report-5abe98b8c85ec3.8621092915224403768207.jpg" alt="" />
            <div className={TeacherCSS.info}>
